...
in
{
  options.bautinix.programs.graphical.desktop.gnome = {
      ...
      options = {
        ...
        background =
          mkOpt
            ...
            {
              picture-uri = get-wallpaper (wallpaperPath config.bautinix.theme.wallpaper.primary);
              picture-uri-dark = get-wallpaper (wallpaperPath config.bautinix.theme.wallpaper.secondary);
            }
