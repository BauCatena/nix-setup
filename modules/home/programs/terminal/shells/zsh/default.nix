    ...
    programs = {
      zsh = {
        ...
        setOptions = [
          ...
          "INTERACTIVE_COMMENTS" # allow comments even in interactive shellss
        ...
        completionInit = /* bash */ ''
          ...
          # shellss starting at once (terminals restoring multiple panes) race and
        ...
        syntaxHighlighting = {
          enable = true;
          highlighters = [
            # NOTE: default priority included
            # "main"
            "brackets"
            "pattern"
            "regexp"
