...
in 
{
  format = "$username[](bg:${catppuccin.palette.surface0.hex} fg:${catppuccin.palette.mauve.hex})$directory[](fg:${catppuccin.palette.surface0.hex} bg:${catppuccin.palette.blue.hex})$git_branch$git_status[](fg:${catppuccin.palette.blue.hex} bg:${catppuccin.palette.yellow.hex})$nodejs$bun$rust$golang$php[](fg:${catppuccin.palette.yellow.hex} bg:${catppuccin.palette.green.hex})$time[ ](fg:${catppuccin.palette.green.hex})$character";
